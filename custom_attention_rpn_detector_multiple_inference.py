...
def main():
    ...
    save_output_image_path = "/home/tanluuuuuuu/Desktop/luunvt/image_retrieval/mmfewshot/result/attention_rpn/door_11thr_attention_rpn"
    ...
    for image_name in tqdm(os.listdir(inference_image_path)):
        image_path = os.path.join(inference_image_path, image_name)
        {
            ...
            #         output_path = os.path.join(save_output_image_path, "exclude", image_name)
            #     else:
            #         output_path = os.path.join(save_output_image_path, "include", image_name)
            #     # show the results
            #     # show_result_pyplot(model, args.image, result, score_thr=score_thr) 
